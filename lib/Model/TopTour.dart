...
//
//     final topTour = topTourFromJson(jsonString);

import 'dart:convert';

List<TopTour> topTourFromJson(String str) => List<TopTour>.from(json.decode(str).map((x) => TopTour.fromJson(x)));

String topTourToJson(List<TopTour> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class TopTour {
  ...
  factory TopTour.fromJson(Map<String, dynamic> json) => TopTour(
    id: json["ID"],
