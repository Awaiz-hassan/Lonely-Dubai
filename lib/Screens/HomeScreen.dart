...
import 'package:lonelydubai/Controllers/DubaiSafariController.dart';
import 'package:lonelydubai/Controllers/TopDestinationsController.dart';
import 'package:lonelydubai/Controllers/TopToursController.dart';
...
import '../Controllers/DhowCruise.dart';
import 'DestinationToTour.dart';
          ...
          Expanded(
            ...
            child: Obx(() => _topDestinationsController.isLoading.value
                ...
                : ListView.builder(
                    ...
                    itemCount:
                        _topDestinationsController.topDestinationList.length,
                              ...
                              MaterialPageRoute(
                                  builder: (context) => DestinationToTour(
                                      ...
                                      _topDestinationsController
                                          ...
                                          .postTitle,_topDestinationsController.topDestinationList[index].destinationImage)));
                        },
                        child: Container(
                          width: 250,
                      ...
                      return GestureDetector(
                        onTap: (){
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => TourDetails(_topToursController.topToursList[index])));
                        },
                        child: Container(
                            ...
                            return GestureDetector(
                              onTap: (){
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) => TourDetails(_dhowCruiseController.dhowCruiseList[index])));
                                },
                              child: Card(
                                elevation: 2.0,
                                      ...
                                      ClipRRect(
                                        ...
                                        child: CachedNetworkImage(
                                          imageUrl: _dhowCruiseController
                                              .dhowCruiseList[index].tourImage,
                                          fit: BoxFit.fill,
                                          width: double.infinity,
                                          height: 80,
                                        ),
      ...
      child: Column(
        ...
        children: [
          ...
          Obx(() => _dubaiSafariController.isLoading.value
              ?  SizedBox(
                  height: 300,
                  child: Center(child: Lottie.asset('assets/animations/loading.json',
                      height: 100.0)
              ...
              : ListView.builder(
                  ...
                  shrinkWrap: true,
                  physics: const NeverScrollableScrollPhysics(),
                  itemCount: _dubaiSafariController.dubaiSafariToursList.length,
                  itemBuilder: (BuildContext context, int index) {
                    return GestureDetector(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => TourDetails(_dubaiSafariController.dubaiSafariToursList[index])));
                      },
                      child: Card(
